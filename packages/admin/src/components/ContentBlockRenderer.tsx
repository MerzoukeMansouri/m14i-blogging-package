...
import type { ContentBlock, ChartBlock } from "@m14i/blogging-core";
...
export function ContentBlockRenderer({
  ...
  switch (block.type) {
    case "text":
      ...
      const isHTML = block.content.trim().startsWith("<") || block.content.includes("</");
    ...
    case "code":
      return (
        <div className={classNames?.code || "my-4"}>
          <SyntaxHighlighter
