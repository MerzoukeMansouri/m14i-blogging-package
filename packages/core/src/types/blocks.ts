...
export type ContentBlockType = "text" | "image" | "video" | "quote" | "code" | "pdf" | "carousel" | "chart";
...
export type ContentBlock = TextBlock | ImageBlock | VideoBlock | QuoteBlock | CodeBlock | PDFBlock | CarouselBlock | ChartBlock;